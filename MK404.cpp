...
int main(int argc, char *argv[])
{
	...
	ValueArg<string> argStrBoot2("","bootloader-file2", "Specifies a .hex file to load as the bootloader for the MMU. If empty, ("") no bootloader is loaded",false,"","file:hex",cmd);
