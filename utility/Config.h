...
class Config
{
	public:
		...
		// Bootloader for secondary:
		inline void SetSecondaryBootloader(std::string strName){ m_strSecBoot = std::move(strName);}
		inline const std::string GetSecondaryBootloader(){ return m_strSecBoot;}
