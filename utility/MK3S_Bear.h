...
class MK3S_Bear: public OBJCollection
{
	public:
		MK3S_Bear(bool bMMU):OBJCollection("Bear")
		{
			...
			m_pKnob = AddObject(ObjClass::Other, "assets/Bear/bear21_mk3s_simulator_lcd_knob.obj",CM_TO_M);
			m_pFan = AddObject(ObjClass::Other, "assets/Bear/bear21_mk3s_simulator_hotend-fan-blade.obj",CM_TO_M);
