...
int main()
 {
// 			baseMap[LCD_PINS_D4] = 19; PD2
// 			baseMap[LCD_PINS_D5] = 70; PG4
// 			baseMap[LCD_PINS_D6] = 85; PH7
// 			baseMap[LCD_PINS_D7] = 71; PG3
// 			baseMap[LCD_PINS_ENABLE] = 18; // PD3
// 			baseMap[LCD_PINS_RS] = 82; PD5
	stdout = &mystdout;
	DDRD = 1 <<5 | 1 <<3 | 1 << 2; // RS / EN / 4
	DDRG = 3 <<3; // D5/D7
	DDRH = 1 <<7; // D6
	sei();
