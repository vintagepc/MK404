/*
	PinSpec_2560.h - Pin translation layer for pins_Einsy.h (arduino pin numbers, ##) to the ATMEL port designator (Px#). 
...
class PinSpec_2560 : public PinSpec
{
	...
	public:
		inline std::string GetMCUName() const override { return "atmega2560"; };

	protected: 
		inline const unsigned char* GetDPin2Port() const override { return DPin2Port;} ;
		inline const unsigned char* GetDPin2Mask() const override { return DPin2Mask;};
		inline const unsigned char* GetDPin2Timer() const override { return DPin2Timer;};

	private:

		static constexpr unsigned char DPin2Timer[] = {
			// TIMERS		
			// -------------------------------------------		
		...
		static constexpr unsigned char DPin2Mask[] = {
			// PIN IN PORT		
			// -------------------------------------------		
		...
		static constexpr unsigned char DPin2Port[] = {
			// PORTLIST		
			// -------------------------------------------		
			PE	, // PE 0 ** 0 ** USART0_RX	
			PE	, // PE 1 ** 1 ** USART0_TX	
