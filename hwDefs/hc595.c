...
static const char * irq_names[IRQ_HC595_COUNT] = {
		...
		[IRQ_HC595_IN_CLOCK] = "<hc595.clk",
		[IRQ_HC595_IN_DATA] = "<hc595.data",
		...
		hc595_t *p)
{
	...
	avr_irq_register_notify(p->irq + IRQ_HC595_IN_CLOCK, hc595_clock_in_hook, p);
	avr_irq_register_notify(p->irq + IRQ_HC595_IN_DATA, hc595_data_in_hook, p);
